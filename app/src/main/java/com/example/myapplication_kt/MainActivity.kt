...
class MainActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        var transNameArray = arrayOf("腳踏車", "機車", "汽車", "巴士");
        var transPhotoIdArray = intArrayOf(R.drawable.trans1, R.drawable.trans2, R.drawable.trans3, R.drawable.trans4);

        var transData = arrayOfNulls<Data>(transNameArray.size);
        ...
        val transAdapter =
            MyAdapter(transData, R.layout.trans_list)
        //------------------------------------------------------------------
        val spinner = findViewById<Spinner>(R.id.spinner)
        spinner.adapter = transAdapter
        val messageArray =
            arrayOf("訊息1", "訊息2", "訊息3", "訊息4", "訊息5", "訊息6")
        val messageAdapter =
        ...
        //------------------------------------------------------------------
        val cubeeNameArray =
            arrayOf("哭哭", "發抖", "再見", "生氣", "昏倒", "竊笑", "很棒", "你好", "驚嚇", "大笑")
        ...
        val cubeeData =
            arrayOfNulls<Data>(cubeeNameArray.size)
        ...
        val cubeeAdapter =
            MyAdapter(cubeeData, R.layout.cubee_list)
    ...
    inner class MyAdapter(
        ...
        override fun getView(
            ...
            val imageView =
                converView.findViewById<ImageView>(R.id.imageView)
